...
1. flat list do canal (1 request) -> cache em scripts/auvp_flat.json
...
Salva scripts/candidatos_auvp_2025.json
"""
...
FLAT_CACHE = "scripts/auvp_flat.json"
...
json.dump({"channel": "AUVP Capital", "range": [start, end], "candidatos": cands},
          io.open("scripts/candidatos_auvp_2025.json", "w", encoding="utf-8"),
          ensure_ascii=False, indent=2)
p(f"\ncandidatos 2025 novos ({MIN_DUR//60}-{MAX_DUR//60}min): {len(cands)}")
p("-> scripts/candidatos_auvp_2025.json")
